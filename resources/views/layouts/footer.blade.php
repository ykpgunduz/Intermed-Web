        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-footer">
                        <h2>Haber Bülteni</h2>
                        <p>Tüm güncel haberlerimizi ve duyurularımızı e-posta kutunuzda görmek için haber bültenimize abone olun.</p>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="copyright-content">
                        <p>© Telif Hakkı 2025  |  Tüm Hakları <a href="https://harpysocial.com" target="_blank">Harpy Social</a> tarafından saklıdır </p>
                    </div>
                </div>
            </div>
        </div>
